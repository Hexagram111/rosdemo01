...
bool base_interfaces_demo__srv__addints__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("base_interfaces_demo.srv._addints.Addints_Request", full_classname_dest, 49) == 0);
  }
...
PyObject * base_interfaces_demo__srv__addints__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("base_interfaces_demo.srv._addints");
...
ROSIDL_GENERATOR_C_EXPORT
bool base_interfaces_demo__srv__addints__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("base_interfaces_demo.srv._addints.Addints_Response", full_classname_dest, 50) == 0);
  }
