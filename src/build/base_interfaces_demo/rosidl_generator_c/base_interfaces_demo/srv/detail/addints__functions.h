...
#ifndef BASE_INTERFACES_DEMO__SRV__DETAIL__ADDINTS__FUNCTIONS_H_
#define BASE_INTERFACES_DEMO__SRV__DETAIL__ADDINTS__FUNCTIONS_H_
...
#endif  // BASE_INTERFACES_DEMO__SRV__DETAIL__ADDINTS__FUNCTIONS_H_
